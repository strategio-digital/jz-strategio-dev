        ...
        return [
            ...
            'paragraphs' => [
                ...
                [
                    ...
                    'text' => 'V sedmé třídě šla má webová kariéra do ústraní a internet ovládla herní videa na Youtube. Závislost na hře Counter-Strike 1.6 nebyla až tak silná, a proto začala nová éra. Stříhání vlastních herních videí ve skvělém Sony Vegas 7.0. Tato éra ovšem velmi rychle skončila. Převálcovala ji závislost na hrách, které se daly stahovat přes BitTorrent.',
                    'images' => []
                ],
                [
                    'year' => '2007',
                ...
                [
                    'year' => '2022',
                    'title' => 'Vývoj Contentio, Invoice GUN, Megio',
                    'text' => 'V roce 2022 byl prostor na vlastní projekty - původně vyvíjená e-shop platforma prošla transformací do pokročilého CRM / CMS, na kterém lze stavět nové weby.<br><br>Také se mi už nechtělo platit za Fakturoid, a proto vznikl Invoice GUN (vlastní systém na faktury). <br><br>Tím vůbec nejzajímavějším projektem se stalo Megio - nástroj, ve kterém lze doslova naklikat profesionální administraci aplikace, Doctrine entity, REST API a úrovně přístupů pro uživatelské skupiny. Zároveň generuje krásný zdrojový kód, který lze dle libosti upravit pro potřeby konkrétního klienta. Tento nástroj šetří mnoho času a peněz a je také zdrojem nových zakázek.',
                    'images' => []
                ],
                [
                    'year' => '2023',
